...
const neighborhoodDataSchema = z
  .object({
    ...
    grandparent__not_responsible_for_grandchild_under_18_fraction: z.number().nullable(),
    grandparent__responsible_for_grandchild_under_18: z.number().nullable(),
    grandparent__responsible_for_grandchild_under_18_fraction: z.number().nullable(),
...
const tractDataSchema = z
  .object({
    ...
    Mgrandparent__not_responsible_for_grandchild_under_18_fraction: z.number().nullable(),
    Mgrandparent__responsible_for_grandchild_under_18: z.number().nullable(),
    Mgrandparent__responsible_for_grandchild_under_18_fraction: z.number().nullable(),
