...
export const load = (async ({ params, route }) => {
  ...
  const validTractsData = skipTractData
    ? new Promise<[]>((resolve) => {
        resolve([]);
      })
    : fetch(
        'https://api.github.com/repos/shi-institute/interactive-web-private-data/contents/northside-24/tracts_data_series.json.deflate',
        {
          method: 'GET',
          headers: {
            Accept: 'application/vnd.github.v3.raw',
...
const neighborhoodDataSchema = z
  .object({
    ...
    grandparent__not_responsible_for_grandchild_under_18: z.number().nullable(),
    grandparent__responsible_for_grandchild_under_18: z.number().nullable(),
    has_computer__black: z.number().nullable().optional(),
    has_computer__black_fraction: z.number().nullable().optional(),
    has_computer__hispanic: z.number().nullable().optional(),
    has_computer__hispanic_fraction: z.number().nullable().optional(),
    has_computer__total: z.number().nullable().optional(),
    has_computer__total_fraction: z.number().nullable().optional(),
    has_computer__white: z.number().nullable().optional(),
    has_computer__white_fraction: z.number().nullable().optional(),
    ...
    internet__broadband__black_fraction: z.number().nullable().optional(),
    internet__broadband__hispanic: z.number().nullable().optional(),
    internet__broadband__hispanic_fraction: z.number().nullable().optional(),
    internet__broadband__total: z.number().nullable().optional(),
    internet__broadband__total_fraction: z.number().nullable().optional(),
    internet__broadband__white: z.number().nullable().optional(),
    internet__broadband__white_fraction: z.number().nullable().optional(),
    ...
    population__25_or_older: z.number(),
    ...
    'tenure__owner_15-24': z.number(),
    'tenure__owner_25-34': z.number(),
    'tenure__owner_35-44': z.number(),
    'tenure__owner_45-54': z.number(),
    'tenure__owner_55-59': z.number(),
    'tenure__owner_60-64': z.number(),
    'tenure__owner_65-74': z.number(),
    'tenure__owner_75-84': z.number(),
    tenure__owner_85_over: z.number(),
    tenure__renter: z.number(),
    'tenure__renter_15-24': z.number(),
    'tenure__renter_25-34': z.number(),
    'tenure__renter_35-44': z.number(),
    'tenure__renter_45-54': z.number(),
    'tenure__renter_55-59': z.number(),
    'tenure__renter_60-64': z.number(),
    'tenure__renter_65-74': z.number(),
    'tenure__renter_75-84': z.number(),
    tenure__renter_85_over: z.number(),
...
const tractDataSchema = z
  .object({
    ...
    Mgrandparent__not_responsible_for_grandchild_under_18: z.number().nullable(),
    Mgrandparent__responsible_for_grandchild_under_18: z.number().nullable(),
    Mhas_computer__black: z.number().nullable().optional(),
    Mhas_computer__black_fraction: z.number().nullable().optional(),
    Mhas_computer__hispanic: z.number().nullable().optional(),
    Mhas_computer__hispanic_fraction: z.number().nullable().optional(),
    Mhas_computer__total: z.number().nullable().optional(),
    Mhas_computer__total_fraction: z.number().nullable().optional(),
    Mhas_computer__white: z.number().nullable().optional(),
    Mhas_computer__white_fraction: z.number().nullable().optional(),
    ...
    Minternet__broadband__black_fraction: z.number().nullable().optional(),
    Minternet__broadband__hispanic: z.number().nullable().optional(),
    Minternet__broadband__hispanic_fraction: z.number().nullable().optional(),
    Minternet__broadband__total: z.number().nullable().optional(),
    Minternet__broadband__total_fraction: z.number().nullable().optional(),
    Minternet__broadband__white: z.number().nullable().optional(),
    Minternet__broadband__white_fraction: z.number().nullable().optional(),
    ...
    Mpopulation__25_or_older: z.number(),
